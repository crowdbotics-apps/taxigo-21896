"""taxigo_21896 URL Configuration
...
admin.site.site_header = "TaxiGo"
admin.site.site_title = "TaxiGo Admin Portal"
admin.site.index_title = "TaxiGo Admin"

# swagger
api_info = openapi.Info(
    title="TaxiGo API",
    default_version="v1",
    description="API documentation for TaxiGo App",
)
